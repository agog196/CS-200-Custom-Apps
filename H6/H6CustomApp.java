...
//
// Title:           Adds the binary numbers input by the user
...
/**
 * This class is the entire program that prompts the user for the number of
 * Binary numbers they want to enter and then prompts the user for the binary
